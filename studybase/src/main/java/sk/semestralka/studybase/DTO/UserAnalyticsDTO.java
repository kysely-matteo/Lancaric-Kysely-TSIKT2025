...
public class UserAnalyticsDTO {
    ...
    public void setTaskStatusStats(Map<String, Long> taskStatusStats) {
        this.taskStatusStats = taskStatusStats;
    }
    ...
    public void setAdminGroups(long adminGroups) {
        this.adminGroups = adminGroups;
    }

    public Long getWeeklyActivities() {
        return weeklyActivities;
    }

    public void setWeeklyActivities(Long weeklyActivities) {
