...
public class GroupAnalyticsDTO {
    ...
    // Getters and Setters - rovnaké ako v backend
    ...
    public List<MemberActivityDTO> getMemberActivities() { return memberActivities; }
    public void setMemberActivities(List<MemberActivityDTO> memberActivities) { this.memberActivities = memberActivities; }
